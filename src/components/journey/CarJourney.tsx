  ...
  const milestones: MilestoneProject[] = [
    {
      ...
      overview: "Predictive employee attrition pipeline evaluating 1,470 samples across 30 variables (0.89 ROC-AUC).",
      problem: "HR managers need quantitative attrition predictions grounded in threshold optimization, MLflow tracking, and feature attribution.",
      whyBuilt: "To bridge the gap between black-box ML predictions and trusted strategic decision-making.",
      architectureNodes: ["1,470 Samples", "SMOTE & Threshold Opt", "XGBoost & PyTorch", "MLflow Logging", "SHAP Waterfall", "Streamlit UI"],
      engineeringDecisions: "Applied SMOTE resampling and threshold optimization achieving a 0.89 ROC-AUC score.",
      tradeoffs: "Logged parameters, metrics, and model artifacts with MLflow across all training experiments.",
      challenges: "Addressing severe class imbalance across 30 feature variables.",
      lessonsLearned: "SHAP-based local feature attribution surfaces exact attrition drivers for decision support.",
    ...
    },
    {
      ...
      overview: "RAG-powered document intelligence converting uploaded PDFs into searchable vector knowledge.",
      problem: "Students spend hours manually creating revision cards from textbook PDFs and scanned documents.",
      whyBuilt: "To automate document vector search retrieval and personalized adaptive study workflows.",
      architectureNodes: ["PDF PyMuPDF Extract", "Sentence Transformers", "ChromaDB Storage", "Context Retrieval", "Groq LLM Generator"],
      engineeringDecisions: "Built a 3-state adaptive difficulty state machine executing evaluation logic in under 50ms.",
      tradeoffs: "Added document hashing, source references, and persistent ChromaDB vector storage.",
      challenges: "Extracting clean text from scanned PDFs using OCR and PyMuPDF.",
      lessonsLearned: "Semantic and metadata-aware retrieval improves response consistency and scalability.",
    ...
    },
    {
      ...
      overview: "Multimodal interview analysis pipeline (468 facial points) and career recommendation system.",
      problem: "Candidates need real-time multi-modal feedback on posture, speech tempo (WPM), and matching company recommendations.",
      whyBuilt: "To provide automated real-time posture, speech, and technical keyword density feedback.",
      architectureNodes: ["MediaPipe 468 Points", "Web Audio Spectrogram", "Tempo & Posture Score", "Company RecSys", "FastAPI / AWS"],
      engineeringDecisions: "Engineered real-time facial and audio spectrogram analysis under 150ms latency.",
      tradeoffs: "Built recommendation system matching candidate profiles to suitable target companies.",
      challenges: "Processing audio and video landmark streams concurrently without frame drop.",
      lessonsLearned: "Asynchronous FastAPI endpoints paired with AWS cloud infrastructure deliver low-latency telemetry.",
